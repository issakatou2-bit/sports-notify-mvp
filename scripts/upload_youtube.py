...
ASSET_META = {
    ...
    "venue_coors": {
        "title": "【MLB】クアーズ・フィールドはなぜ点が入る？｜標高1600mの球場 #Shorts",
        "lead": [
            "コロラド州デンバー、ロッキーズの本拠地。"
    ...
    "venue_fenway": {
        "title": "【MLB】高さ11mの壁「グリーンモンスター」｜フェンウェイ・パーク #Shorts",
        "lead": [
    ...
    "venue_wrigley": {
        "title": "【MLB】風で試合が変わる球場｜リグレー・フィールド #Shorts",
        "lead": [
            "イリノイ州シカゴ、カブスの本拠地。"
    ...
    "venue_oracle": {
        "title": "【MLB】打球が海に落ちる球場｜オラクル・パーク #Shorts",
        "lead": [
    ...
    "venue_yankee": {
        "title": "【MLB】左打者に有利な理由｜ヤンキー・スタジアム #Shorts",
        "lead": [
    ...
    "collespo_guide": {
        "title": "毎日19時、今日の注目試合が理由つきで届きます｜コレスポの使い方 #Shorts",
        "lead": [
