...
# 打席の少ない選手。1打数1安打なら打率1.000で、これは正しい。
#
# 上限を0.5にしていたため、8/29はこの1行で6本すべてが止まった。
# 「規定打席に達した打者は5割を超えない」は本当だが、
# 打席数の分からない行にその話を当てると、実在の選手を弾く。
ok("打席の少ない控え選手", "今季 打率1.000　0本塁打　0打点")
ok("まだ無安打の選手", "今季 打率.000　0本塁打　0打点")
